...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $string = "http://api.openweathermap.org/data/2.5/weather?q=".$add_city."&units=metric&appid=38352e331b65296cc9e863b8f6383594";
            ...
            <div class="columns">
                ...
                <?php
                    ...
                    if ($result->num_rows > 0) 
                    {
                        ...
                        {
                            $city = $row["city"];
                            $string = "http://api.openweathermap.org/data/2.5/weather?q=".$city."&units=metric&appid=38352e331b65296cc9e863b8f6383594";
